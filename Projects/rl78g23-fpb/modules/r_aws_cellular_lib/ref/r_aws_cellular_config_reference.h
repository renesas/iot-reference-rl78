 ...
 **********************************************************************************************************************/
#define AWS_CELLULAR_CFG_AP_NAME            ap_name      /* Access point name */
#define AWS_CELLULAR_CFG_AP_USERID          ap_userid    /* Login ID */
#define AWS_CELLULAR_CFG_AP_PASSWORD        ap_password  /* Access point password */
#define AWS_CELLULAR_CFG_PIN_CODE           0000         /* SIM card PIN code */
#define AWS_CELLULAR_CFG_AUTH_TYPE          (1)          /* Authentication protocol type (0=None,1=PAP,2=CHAP)*/
...
#define AWS_CELLULAR_CFG_SCI_CH                 (0)      /* SCI channel */
...
#define AWS_CELLULAR_CFG_RTS_PORT               0           /* RTS port number */
#define AWS_CELLULAR_CFG_RTS_PIN                2           /* RTS pin number */

#define AWS_CELLULAR_CFG_RESET_PORT             5           /* Reset port number */
#define AWS_CELLULAR_CFG_RESET_PIN              5           /* Reset pin number */
