 ...
 * Macro definitions
 **********************************************************************************************************************/
#define RM_CELLULAR_RYZ_MAX_PDP_CONTEXTS                    (6U) // MAX valid PDP contexts
...
#if (AWS_CELLULAR_CFG_DEBUGLOG != 0)
/* print debug info */
#include "logging_levels.h"

/* Logging configuration */
#ifndef LIBRARY_LOG_NAME
    #define LIBRARY_LOG_NAME    "Renesas RYZ024A driver"
#endif

#ifndef LIBRARY_LOG_LEVEL
    #define LIBRARY_LOG_LEVEL   (AWS_CELLULAR_CFG_DEBUGLOG)
#endif
